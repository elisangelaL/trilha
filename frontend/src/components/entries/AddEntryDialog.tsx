...
const CATEGORY_OPTIONS: { value: EntryCategory; label: string }[] = [
  ...
  { value: "comer", label: "Comer & beber" },
  { value: "hospedagem", label: "Hospedagem" },
  { value: "transporte", label: "Transporte" },
];

export function AddEntryDialog({ onClose, onSubmit }: { onClose: () => void; onSubmit: (input: NewEntryInput) => Promise<unknown> }) {
  const [type, setType] = useState<EntryType>("photo");
  const [category, setCategory] = useState<EntryCategory>("visitar");
